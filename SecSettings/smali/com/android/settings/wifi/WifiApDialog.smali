...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mView:Landroid/view/View;
    ...
    .line 438
    iget-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mView:Landroid/view/View;
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mSecurity:Landroid/widget/Spinner;
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings/wifi/WifiApDialog;->setView(Landroid/view/View;)V
    ...
    sput-object v7, Lcom/android/settings/wifi/WifiApDialog;->sSalesCode:Ljava/lang/String;

    .line 451
    new-instance v6, Lcom/android/settings/Utils$LengthFilter;

    iget-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mContext:Landroid/content/Context;

    invoke-direct {v6, v7}, Lcom/android/settings/Utils$LengthFilter;-><init>(Landroid/content/Context;)V

    .line 452
    .local v6, "lengthFilter":Lcom/android/settings/Utils$LengthFilter;
    iget-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mView:Landroid/view/View;
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mSsid:Landroid/widget/EditText;
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mPassword:Landroid/widget/EditText;
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mHideSsid:Landroid/widget/CheckBox;
    ...
    invoke-virtual {v7, v8}, Landroid/widget/CheckBox;->setOnFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V
    ...
    .line 468
    .local v1, "advanced":Landroid/widget/CheckBox;
    const/4 v7, 0x0
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mChannel:Landroid/widget/Spinner;
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->CheckBoxChannel2g:Landroid/widget/CheckBox;
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->CheckBoxChannel5g:Landroid/widget/CheckBox;
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mChannel5g:Landroid/widget/Spinner;
    ...
    iput v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mNumBasedOnCountry:I
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->wifiAp5gItem:[Ljava/lang/String;
    ...
    .line 507
    iget-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->wifiAp5gItem:[Ljava/lang/String;

    iget-object v8, p0, Lcom/android/settings/wifi/WifiApDialog;->wifiAp5gItemBasedOnCharger:[Ljava/lang/String;
    ...
    .line 509
    :cond_1
    iget v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mNumBasedOnCountry:I

    if-lez v7, :cond_2

    .line 510
    iget v5, p0, Lcom/android/settings/wifi/WifiApDialog;->mNumBasedOnCharger:I
    ...
    iget-object v8, p0, Lcom/android/settings/wifi/WifiApDialog;->wifiAp5gItemBasedOnCountry:[Ljava/lang/String;
    ...
    .line 516
    iget-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->mChannel5g:Landroid/widget/Spinner;
    ...
    invoke-virtual {p0, v7, v8, v9}, Lcom/android/settings/wifi/WifiApDialog;->setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings/wifi/WifiApDialog;->setTitle(I)V
    ...
    invoke-virtual {v7, v8}, Landroid/widget/EditText;->append(Ljava/lang/CharSequence;)V
    ...
    sget-boolean v7, Lcom/android/settings/wifi/WifiApDialog;->mWifiShowPassword:Z
    ...
    invoke-static {v8, v9, v3}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->maxClientSpinner:Landroid/widget/Spinner;
    ...
    .line 674
    iget-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->maxClientSpinner:Landroid/widget/Spinner;
    ...
    iput-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->timeoutSettingsSpinner:Landroid/widget/Spinner;
    ...
    .line 680
    :cond_9
    iget-object v7, p0, Lcom/android/settings/wifi/WifiApDialog;->timeoutSettingsSpinner:Landroid/widget/Spinner;
    ...
    iget v8, p0, Lcom/android/settings/wifi/WifiApDialog;->mSelectedTimeoutValue:I
    ...
    invoke-virtual {v7, v8, v9}, Landroid/view/inputmethod/InputMethodManager;->showSoftInput(Landroid/view/View;I)Z
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    :sswitch_data_0
    .sparse-switch
        0x7f100555 -> :sswitch_0
        0x7f100556 -> :sswitch_1
        0x7f10055e -> :sswitch_2
        0x7f10055f -> :sswitch_3
        0x7f100561 -> :sswitch_4
        0x7f100563 -> :sswitch_5
    .end sparse-switch
.end method
